...
public class SessionView extends LinearLayout {
   ...
   /**
    * Constructor for SessionView object. Sets internal session to the specified
    * session
    */
   ...
   public void setSession(Session session) {
      ...
      if (session.getSessionName().equals("")) {
         ...
         if (session.getSessionDate() != null)
            this.m_vwSessionName
                  .setText(session.getSessionName()
                        + " ("
                        + Session.SESSION_DATE_FORMAT.format(session
                              .getSessionDate()) + ")");
      }
    ...
    * @param listener OnSessionChangeListener
    */
   ...
   public void notifyOnSessionChangeListener(){
      if(this.m_onSessionChangeListener != null){
         this.m_onSessionChangeListener.onSessionChanged(this, this.m_session);
      }
   }
